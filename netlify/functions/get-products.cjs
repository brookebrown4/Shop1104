...
exports.handler = async (event) => {
  ...
  let query = supabase
    .from("products")
    .select("id, name, price_cents, category, portal_code, colors, sizes, sizes_enabled, threads, placements, logos, addons, image_data, images, hidden, sold_out, featured, sort_order")
    .eq("hidden", false)
